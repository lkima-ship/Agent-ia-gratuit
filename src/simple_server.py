# Créer un nouveau serveur corrigé
...
echo '        self.wfile.write(b"Agent IA Gratuit - Serveur actif!")' >> server.py
echo '' >> server.py
echo 'print("🤖 Agent IA Gratuit - Serveur Web")' >> server.py
echo 'print("=================================")' >> server.py
echo 'print(f"🚀 Démarrage sur le port {PORT}...")' >> server.py
echo 'print(f"📡 Accédez à: http://localhost:{PORT}")' >> server.py
echo 'print("🛑 Pour arrêter: Ctrl+C")' >> server.py
echo '' >> server.py
